...
public class mainpatient extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // android.support.v4.app.FragmentTransaction fragmentTransaction =
        ...
        fragmentTransaction.add(R.id.main_container,new Profilefrag());
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId())
                {
                    case R.id.nav_profile:
                        fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.main_container, new Profilefrag());
                        fragmentTransaction.commit();
                        getSupportActionBar().setTitle("Profile");
                    ...
                    case R.id.nav_doctor:
                        fragmentTransaction = getSupportFragmentManager().beginTransaction();
                        fragmentTransaction.replace(R.id.main_container, new Doctorfrag());
                        fragmentTransaction.commit();
